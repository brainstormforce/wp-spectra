    ...
    return (
        ...
        >
            ...
            <div className="flex-1 min-w-0">
                ...
                <a className="text-sm underline text-gray-900 truncate" href={ `https://ultimategutenberg.com/blocks/${ link }` } target="_blank"rel="noreferrer">{__( 'Live Demo', 'ultimate-addons-for-gutenberg' )}</a>
            </div>
            <Switch
