    ...
    return (
        ...
        >
            ...
            <div className="flex-1 min-w-0">
                ...
                <a className="text-sm text-gray-900 focus:text-gray-700 active:text-gray-700 hover:text-gray-700 truncate underline" href='https://ultimategutenberg.com/docs/masonry-image-gallery/' target="_blank"rel="noreferrer">{__( 'Documentation', 'ultimate-addons-for-gutenberg' )}</a>
            </div>
            <Switch
