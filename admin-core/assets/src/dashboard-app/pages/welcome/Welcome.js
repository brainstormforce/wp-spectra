							...
							<div className="rounded-md bg-white overflow-hidden shadow-sm flex flex-col justify-center h-full">
								<div className="p-12 pt-[2.2rem]">
									...
									<div className="mr-[80px] spectra-video-container">
										...
										<iframe className="spectra-video" src={`https://www.youtube-nocookie.com/embed/GLNzTxArR6Y?showinfo=0&autoplay=${allowAutoPlay}&mute=${allowAutoPlay}&rel=0`} allow="autoplay" title="YouTube video player" frameBorder="0" allowFullScreen></iframe>
									</div>
