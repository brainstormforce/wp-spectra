    ...
    return (
        <section className='block border-b border-solid border-slate-200 px-12 py-8 justify-between'>  
            ...
            <p className="mt-2 w-9/12 text-sm text-slate-500">
                ...
                <a className='text-spectra focus:text-spectra-hover active:text-spectra-hover hover:text-spectra-hover' href="https://wpspectra.com/clean-html-with-uag/?utm_source=uag-dashboard&utm_medium=link&utm_campaign=uag-dashboard" target='_blank'> { __( 'this article', 'ultimate-addons-for-gutenberg' ) } </a>
