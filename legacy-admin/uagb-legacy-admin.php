...
if ( ! class_exists( 'UAGB_Legacy_Admin' ) ) {
	...
	final class UAGB_Legacy_Admin {
		...
		public static function styles_scripts() {
			...
			// Styles.
			wp_enqueue_style( 'uagb-admin-settings', UAGB_URL . 'admin-legacy/assets/admin-menu-settings.css', array(), UAGB_VER, 'all' );
			// Script.
			wp_enqueue_script( 'uagb-admin-settings', UAGB_URL . 'admin-legacy/assets/admin-menu-settings.js', array( 'jquery', 'wp-util', 'updates' ), UAGB_VER, true );
