...
import { useState, useRef, useEffect, Fragment, cloneElement, Children } from '@wordpress/element';
                ...
                <div ref={tabContainer} className={classnames(
                ...
                )}>
                    {
                        tabs.indexOf( LAYOUT ) > -1 && (
                            <Tooltip text={ __( 'General', 'ultimate-addons-for-gutenberg' ) }>
                                <button className={ classnames({ 'uagb-active': currentTab === LAYOUT }) } onClick={ () => onTabChange( LAYOUT ) }>
                                    ...
                                    <h5>{ __( 'General', 'ultimate-addons-for-gutenberg' )}</h5>
                                </button>
                            </Tooltip>
                        )
                    }
                    {
                        tabs.indexOf( STYLE ) > -1 && (
                            <Tooltip text={ __( 'Style', 'ultimate-addons-for-gutenberg' ) }>
                                <button className={ classnames({ 'uagb-active': currentTab === STYLE }) } onClick={ () => onTabChange( STYLE ) }>
                                    ...
                                    <h5>{ __( 'Style', 'ultimate-addons-for-gutenberg' )}</h5>
                                </button>
                            </Tooltip>
                        )
                    }
                    {
                        tabs.indexOf( ADVANCE ) > -1 && (
                            <Tooltip text={ __( 'Advanced', 'ultimate-addons-for-gutenberg' ) }>
                                <button className={ classnames({ 'uagb-active': currentTab === ADVANCE }) } onClick={ () => onTabChange( ADVANCE ) }>
                                    ...
                                    <h5>{ __( 'Advanced', 'ultimate-addons-for-gutenberg' )}</h5>
                                </button>
                            </Tooltip>
                        )
                    }
