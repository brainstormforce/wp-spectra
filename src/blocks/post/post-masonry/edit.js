...
const UAGBPostMasonry = ( props ) => {
	...
	useEffect(() => {
		...
		$style.setAttribute( "id", "uagb-post-masonry-style-" + props.clientId.substr( 0, 8 ) )
		document.head.appendChild( $style )
	}, []);

	useEffect(() => {

		var element = document.getElementById( "uagb-post-masonry-style-" + props.clientId.substr( 0, 8 ) )
	...
	return (
		<>
			<Settings parentProps={ props }  state={state} inspectorControls={inspectorControls} />
			<Render parentProps={ props } state={state} setState={setState} togglePreview={togglePreview} />
		</>
	)
