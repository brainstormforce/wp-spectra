...
function styling( props ) {
	...
	const widthSelectorsDesktop = {
		[`.is-root-container .uagb-is-root-container.block-editor-block-list__block .block-editor-block-list__block#block-${ props.clientId } `] : {
	...
	const widthSelectorsTablet = {
		[`.is-root-container .uagb-is-root-container.block-editor-block-list__block .uagb-editor-preview-mode-tablet.block-editor-block-list__block#block-${ props.clientId } `] : {
	...
	const widthSelectorsMobile = {
		[`.is-root-container .uagb-is-root-container.block-editor-block-list__block .uagb-editor-preview-mode-mobile.block-editor-block-list__block#block-${ props.clientId } `] : {
	...
	if ( 'alignfull' === contentWidth && 'alignwide' === innerContentWidth ) {
		...
		widthSelectorsDesktop[`.is-root-container .uagb-is-root-container.block-editor-block-list__block.wp-block-uagb-container.uagb-block-${ block_id } > .uagb-container-inner-blocks-wrap`] = {
		...
		widthSelectorsTablet[`.is-root-container .uagb-is-root-container.block-editor-block-list__block.uagb-editor-preview-mode-table.wp-block-uagb-container.uagb-block-${ block_id } > .uagb-container-inner-blocks-wrap`] = {
