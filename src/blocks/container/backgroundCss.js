...
const backgroundCss = ( attributes, deviceType, clientId, pseudoElementOverlay = {} ) => {
	...
	const backgroundAttributesMobile = {
		...
		gradientColor1,
		gradientColor2,
		gradientLocation1: gradientLocationMobile1 ? gradientLocationMobile1 : backgroundAttributesTablet.gradientLocationTablet1,
		gradientLocation2: gradientLocationMobile2 ? gradientLocationMobile2 : backgroundAttributesTablet.gradientLocationTablet2,
		gradientType,
		gradientAngle: gradientAngleMobile ? gradientAngleMobile : backgroundAttributesTablet.gradientAngleTablet,
		selectGradient,
