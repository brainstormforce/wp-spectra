...
const tabSettings = props => {
    ...
    const tabStyleSettings = () => {
        return 	<PanelBody title={ __( 'Tabs Style'  , 'ultimate-addons-for-gutenberg' ) }  initialOpen={ true }>
                    <Columnresponsive/>
                    { "Desktop" === deviceType && (
                            <>
                            <SelectControl
    ...
    const tabTitleSettings = () => {
        return <PanelBody title={ __( 'Tabs Title Settings'  , 'ultimate-addons-for-gutenberg' ) }  initialOpen={ false }>
            <SelectControl
    ...
    const tabBorderSettings = () => {
        return 	<PanelBody title={ __( 'Border Settings'  , 'ultimate-addons-for-gutenberg') } initialOpen={ false }>
    ...
    const tabBodySettings = () => {
        return <PanelBody title={ __( 'Tabs Body Settings'  , 'ultimate-addons-for-gutenberg') } initialOpen={ false }>
