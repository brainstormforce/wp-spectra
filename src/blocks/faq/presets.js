...
const presets = [
	...
	},
    {
        ...
        attributes: [
			...
			{ label: 'borderTopWidth', value: 1},
			{ label: 'borderRightWidth', value: 1},
			{ label: 'borderBottomWidth', value: 1},
			{ label: 'borderLeftWidth', value: 1},
			{ label: 'borderTopRadius', value: 4},
			{ label: 'borderRightRadius', value: 4},
			{ label: 'borderBottomRadius', value: 4},
			{ label: 'borderLeftRadius', value: 4},
    ...
    },
    {
        ...
        attributes: [
			...
			{ label: 'borderBottomWidth', value: 1},
			{ label: 'borderLeftWidth', value: 1},
			{ label: 'borderTopRadius', value: 5},
			{ label: 'borderRightRadius', value: 5},
			{ label: 'borderBottomRadius', value: 5},
			{ label: 'borderLeftRadius', value: 5},
			{ label: 'borderColor' , value: '#dedede' },
			{ label: 'boxBgColor' , value: 'transparent'},
