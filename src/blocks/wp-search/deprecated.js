...
import renderSVG2 from '@Controls/renderIcon';
import { RichText as RichTextNew } from '@wordpress/block-editor';
			...
			const renderMinimal = () => {
				if ( 'input' === layout ) {
					return (
						...
						>
							<div className="uagb-search-form__container" role="tablist">
								<span className="uagb-wp-search-icon-wrap">{ renderSVG2( 'fas fa-search' ) }</span>
								<input
									placeholder={ placeholder }
									className="uagb-search-form__input"
									type="search"
