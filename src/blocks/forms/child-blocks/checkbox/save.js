	...
	return (
		<div className={ classnames(
			...
			{options.map((o, index) => {
				...
				return (
					<Fragment>
					<input type="checkbox"  id={`checkbox-${value}-${block_id}`} name={ `${checkboxName}[]` } value={ optionvalue } required={ checkboxRequired }  oninvalid="this.setCustomValidity('Please check this box if you want to proceed.')"/>
