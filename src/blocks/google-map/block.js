			...
			<Fragment>
				<InspectorControls>
					<PanelBody title={ __( "General" ) } >
						<p className="uagb-google-map-notice">{ __( "This module uses UAGB's API key to display the map. You don't need to create your own API key or worry about renewing it." ) }</p>
