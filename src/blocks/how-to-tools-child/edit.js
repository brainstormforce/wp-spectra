...
class UAGBHowToToolsChild extends Component {
	...
	componentDidMount() {
		...
		$style.setAttribute( "id", "uagb-style-how-to-tools-child-" + this.props.clientId )
	...
	render() {
		...
		var element = document.getElementById( "uagb-style-how-to-tools-child-" + this.props.clientId )
								...
								return (
									<div
										className={ classnames(
											`uagb-how-to-tools-child-repeater`,
