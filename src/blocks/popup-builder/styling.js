...
export default function styling( attributes, clientId, name, deviceType ) {
	...
	const backgroundAttributesTablet = {
		...
		'gradientColor1': gradientColor1,
		'gradientColor2': gradientColor2,
		'gradientLocation1': 'number' === typeof gradientLocationTablet1 ? gradientLocationTablet1 : backgroundAttributesDesktop.gradientLocation1,
		'gradientLocation2': 'number' === typeof gradientLocationTablet2 ? gradientLocationTablet2 : backgroundAttributesDesktop.gradientLocation2,
		'gradientType': gradientType,
		'gradientAngle': 'number' === typeof gradientAngleTablet ? gradientAngleTablet : backgroundAttributesDesktop.gradientAngle,
