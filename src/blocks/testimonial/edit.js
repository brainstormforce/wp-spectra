...
const UAGBtestimonial = props => {
	...
	useEffect( () => {
		...
		$style.setAttribute( "id", "uagb-testinomial-style-" + props.clientId.substr( 0, 8 ) )
		document.head.appendChild( $style )
	}, [] );

	useEffect( () => {
		var element = document.getElementById( "uagb-testinomial-style-" + props.clientId.substr( 0, 8 ) )
