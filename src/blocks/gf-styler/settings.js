    ...
    const {
		...
		*/
        ...
        const fieldBorderSetting = () => {
			return <PanelBody title={ __( "Field Style & Border",'ultimate-addons-for-gutenberg' ) } initialOpen = { false } > 	
				<SelectControl
		...
		const fieldSettings = () => {			
			return <PanelBody title={ __( "General",'ultimate-addons-for-gutenberg' ) } >
				<SelectControl
		...
		const btnSetting = () => {
			return  <PanelBody title={ __( "Submit Button",'ultimate-addons-for-gutenberg' ) } initialOpen={ false }>
				<SelectControl
		...
		const radioCheckSetting = () => {
			return <PanelBody title={ __( "Radio & Checkbox",'ultimate-addons-for-gutenberg' ) } initialOpen={ false }>
				<ToggleControl
		...
		const msgSettings = () => {			
			return <PanelBody title={ __( "Success / Error Message",'ultimate-addons-for-gutenberg' ) } initialOpen={ false }>
