			...
			<PanelBody title={ __( "Content" ) } initialOpen = { false } > 
		    	...
		    	{ ( ! enableLabel ) && <Fragment>
					...
					<TypographyControl
						...
						loadGoogleFonts = { { value: labelLoadGoogleFonts, label: __( "Font Family" ) } }
						fontFamily = { { value: labelFontFamily, label: __( "Font Family" ) } }
						fontWeight = { { value: labelFontWeight, label: __( "Font Weight" ) } }
						fontSubset = { { value: labelFontSubset, label: __( "Font Subset" ) } }
						fontSizeType = { { value: labelFontSizeType, label: __( "Line Height Type" ) } }
						fontSize = { { value: labelFontSize, label: __( "Line Height" ) } }
						fontSizeMobile = { { value: labelFontSizeMobile, label: __( "Font Size" ) } }
						fontSizeTablet= { { value: labelFontSizeTablet, label: __( "Font Size" ) } }
						lineHeightType = { { value: labelLineHeightType, label: __( "Line Height Type" ) } }
						lineHeight = { { value: labelLineHeight, label: __( "Line Height" ) } }
						lineHeightMobile = { { value: labelLineHeightMobile, label: __( "Line Height" ) } }
						lineHeightTablet= { { value: labelLineHeightTablet, label: __( "Line Height" ) } }
					/>
				...
				<TypographyControl
					...
					attributes = { attributes }
					setAttributes = { setAttributes }
					loadGoogleFonts = { { value: inputLoadGoogleFonts, label: __( "Font Family" ) } }
					fontFamily = { { value: inputFontFamily, label: __( "Font Family" ) } }
					fontWeight = { { value: inputFontWeight, label: __( "Font Weight" ) } }
					fontSubset = { { value: inputFontSubset, label: __( "Font Subset" ) } }
					fontSizeType = { { value: inputFontSizeType, label: __( "Line Height Type" ) } }
					fontSize = { { value: inputFontSize, label: __( "Line Height" ) } }
					fontSizeMobile = { { value: inputFontSizeMobile, label: __( "Font Size" ) } }
					fontSizeTablet= { { value: inputFontSizeTablet, label: __( "Font Size" ) } }
					lineHeightType = { { value: inputLineHeightType, label: __( "Line Height Type" ) } }
					lineHeight = { { value: inputLineHeight, label: __( "Line Height" ) } }
					lineHeightMobile = { { value: inputLineHeightMobile, label: __( "Line Height" ) } }
					lineHeightTablet= { { value: inputLineHeightTablet, label: __( "Line Height" ) } }
				/>	
				<p className="uagb-setting-label">{ __( "Color" ) }
					<span className="components-base-control__label">
		...
		const btn_setting = (
			<PanelBody title={ __( "Submit Button" ) } initialOpen={ false }>
				...
				<TypographyControl
					...
					attributes = { attributes }
					setAttributes = { setAttributes }
					loadGoogleFonts = { { value: buttonLoadGoogleFonts, label: __( "Font Family" ) } }
					fontFamily = { { value: buttonFontFamily, label: __( "Font Family" ) } }
					fontWeight = { { value: buttonFontWeight, label: __( "Font Weight" ) } }
					fontSubset = { { value: buttonFontSubset, label: __( "Font Subset" ) } }
					fontSizeType = { { value: buttonFontSizeType, label: __( "Line Height Type" ) } }
					fontSize = { { value: buttonFontSize, label: __( "Line Height" ) } }
					fontSizeMobile = { { value: buttonFontSizeMobile, label: __( "Font Size" ) } }
					fontSizeTablet= { { value: buttonFontSizeTablet, label: __( "Font Size" ) } }
					lineHeightType = { { value: buttonLineHeightType, label: __( "Line Height Type" ) } }
					lineHeight = { { value: buttonLineHeight, label: __( "Line Height" ) } }
					lineHeightMobile = { { value: buttonLineHeightMobile, label: __( "Line Height" ) } }
					lineHeightTablet= { { value: buttonLineHeightTablet, label: __( "Line Height" ) } }
				/>
				<hr className="uagb-editor__separator" />								
				{ btn_border_setting }
				<hr className="uagb-editor__separator" />
			...
			<PanelBody title={ __( "Radio & Checkbox" ) } initialOpen={ false }>
				...
				{ enableOveride && <Fragment>
					...
					<TypographyControl
						...
						attributes = { attributes }
						setAttributes = { setAttributes }
						loadGoogleFonts = { { value: radioCheckLoadGoogleFonts, label: __( "Font Family" ) } }
						fontFamily = { { value: radioCheckFontFamily, label: __( "Font Family" ) } }
						fontWeight = { { value: radioCheckFontWeight, label: __( "Font Weight" ) } }
						fontSubset = { { value: radioCheckFontSubset, label: __( "Font Subset" ) } }
						fontSizeType = { { value: radioCheckFontSizeType, label: __( "Line Height Type" ) } }
						fontSize = { { value: radioCheckFontSize, label: __( "Line Height" ) } }
						fontSizeMobile = { { value: radioCheckFontSizeMobile, label: __( "Font Size" ) } }
						fontSizeTablet= { { value: radioCheckFontSizeTablet, label: __( "Font Size" ) } }
						lineHeightType = { { value: radioCheckLineHeightType, label: __( "Line Height Type" ) } }
						lineHeight = { { value: radioCheckLineHeight, label: __( "Line Height" ) } }
						lineHeightMobile = { { value: radioCheckLineHeightMobile, label: __( "Line Height" ) } }
						lineHeightTablet= { { value: radioCheckLineHeightTablet, label: __( "Line Height" ) } }
					/>
					<hr className="uagb-editor__separator" />
		...
		const msg_settings = (			
			<PanelBody title={ __( "Success / Error Message" ) } initialOpen={ false }>
				...
				<TypographyControl
					...
					attributes = { attributes }
					setAttributes = { setAttributes }
					loadGoogleFonts = { { value: validationMsgLoadGoogleFonts, label: __( "Font Family" ) } }
					fontFamily = { { value: validationMsgFontFamily, label: __( "Font Family" ) } }
					fontWeight = { { value: validationMsgFontWeight, label: __( "Font Weight" ) } }
					fontSubset = { { value: validationMsgFontSubset, label: __( "Font Subset" ) } }
					fontSizeType = { { value: validationMsgFontSizeType, label: __( "Line Height Type" ) } }
					fontSize = { { value: validationMsgFontSize, label: __( "Line Height" ) } }
					fontSizeMobile = { { value: validationMsgFontSizeMobile, label: __( "Font Size" ) } }
					fontSizeTablet= { { value: validationMsgFontSizeTablet, label: __( "Font Size" ) } }
					lineHeightType = { { value: validationMsgLineHeightType, label: __( "Line Height Type" ) } }
					lineHeight = { { value: validationMsgLineHeight, label: __( "Line Height" ) } }
					lineHeightMobile = { { value: validationMsgLineHeightMobile, label: __( "Line Height" ) } }
					lineHeightTablet= { { value: validationMsgLineHeightTablet, label: __( "Line Height" ) } }
				/>
				...
				<TypographyControl
					...
					attributes = { attributes }
					setAttributes = { setAttributes }
					loadGoogleFonts = { { value: msgLoadGoogleFonts, label: __( "Font Family" ) } }
					fontFamily = { { value: msgFontFamily, label: __( "Font Family" ) } }
					fontWeight = { { value: msgFontWeight, label: __( "Font Weight" ) } }
					fontSubset = { { value: msgFontSubset, label: __( "Font Subset" ) } }
					fontSizeType = { { value: msgFontSizeType, label: __( "Line Height Type" ) } }
					fontSize = { { value: msgFontSize, label: __( "Line Height" ) } }
					fontSizeMobile = { { value: msgFontSizeMobile, label: __( "Font Size" ) } }
					fontSizeTablet= { { value: msgFontSizeTablet, label: __( "Font Size" ) } }
					lineHeightType = { { value: msgLineHeightType, label: __( "Line Height Type" ) } }
					lineHeight = { { value: msgLineHeight, label: __( "Line Height" ) } }
					lineHeightMobile = { { value: msgLineHeightMobile, label: __( "Line Height" ) } }
					lineHeightTablet= { { value: msgLineHeightTablet, label: __( "Line Height" ) } }
				/>			
				...
				<TypographyControl
					...
					attributes = { attributes }
					setAttributes = { setAttributes }
					loadGoogleFonts = { { value: successMsgLoadGoogleFonts, label: __( "Font Family" ) } }
					fontFamily = { { value: successMsgFontFamily, label: __( "Font Family" ) } }
					fontWeight = { { value: successMsgFontWeight, label: __( "Font Weight" ) } }
					fontSubset = { { value: successMsgFontSubset, label: __( "Font Subset" ) } }
					fontSizeType = { { value: successMsgFontSizeType, label: __( "Line Height Type" ) } }
					fontSize = { { value: successMsgFontSize, label: __( "Line Height" ) } }
					fontSizeMobile = { { value: successMsgFontSizeMobile, label: __( "Font Size" ) } }
					fontSizeTablet= { { value: successMsgFontSizeTablet, label: __( "Font Size" ) } }
					lineHeightType = { { value: successMsgLineHeightType, label: __( "Line Height Type" ) } }
					lineHeight = { { value: successMsgLineHeight, label: __( "Line Height" ) } }
					lineHeightMobile = { { value: successMsgLineHeightMobile, label: __( "Line Height" ) } }
					lineHeightTablet= { { value: successMsgLineHeightTablet, label: __( "Line Height" ) } }
				/>				
