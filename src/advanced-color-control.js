         ...
         return (
             <div className="uagb-advanced-color-settings-container">
                 { this.state.isVisible && (
                     <Popover position="top left" className="uagb-popover-color" onClose={ toggleClose }>
                         <ColorPicker
                 ...
                 { this.state.isVisible && (
                     <Tooltip text={ __( 'Edit Color' ) }>
                         <Button className={ 'uagb-color-icon-indicate' } onClick={ toggleClose }>
                             <ColorIndicator className="uagb-advanced-color-indicate" colorValue={ ( 'transparent' === this.state.color || undefined === this.state.color || '' === this.state.color ? this.props.colorDefault : this.state.color ) } />
                         </Button>
                     </Tooltip>
                 ) }
                 { ! this.state.isVisible && (
                     <Tooltip text={ __( 'Edit Color' ) }>
                         <Button className={ 'uagb-color-icon-indicate' } onClick={ toggleVisible }>
                             <ColorIndicator className="uagb-advanced-color-indicate" colorValue={ ( 'transparent' === this.state.color || undefined === this.state.color || '' === this.state.color ? this.props.colorDefault : this.state.color ) } />
                         </Button>
                     </Tooltip>
                 ) }
