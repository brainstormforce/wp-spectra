 ...
 */
 ...
 class AdvancedColorControl extends Component {
     ...
     render() {
         ...
         return (
             <div className="uagb-color-popover-container">
                     ...
                     <div className="uagb-beside-color-click">
                         { this.state.isVisible && (
                             <Tooltip text={ __( 'Select Color' ) }>
                                 <Button className={ `uagb-color-icon-indicate ${ ( this.props.onOpacityChange ? 'uagb-has-alpha' : 'uagb-no-alpha' ) }` } onClick={ toggleClose }>
                                     <ColorIndicator className="uagb-advanced-color-indicate" colorValue={ ( 'transparent' === this.props.colorValue || undefined === this.props.colorValue || '' === this.props.colorValue ? this.props.colorDefault : hexToRGBA( this.props.colorValue, ( this.props.opacityValue !== undefined ? this.props.opacityValue : 1 ) ) ) } />
                                 </Button>
                             </Tooltip>
                         ) }
                         { ! this.state.isVisible && (
                             <Tooltip text={ __( 'Select Color' ) }>
                                 <Button className={ `uagb-color-icon-indicate ${ ( this.props.onOpacityChange ? 'uagb-has-alpha' : 'uagb-no-alpha' ) }` } onClick={ toggleVisible }>
                                     <ColorIndicator className="uagb-advanced-color-indicate" colorValue={ ( 'transparent' === this.props.colorValue || undefined === this.props.colorValue || '' === this.props.colorValue ? this.props.colorDefault : hexToRGBA( this.props.colorValue, ( this.props.opacityValue !== undefined ? this.props.opacityValue : 1 ) ) ) } />
                                 </Button>
                             </Tooltip>
                         ) }
                 ...
                 { this.state.isVisible && (
                     <div className="uagb-inner-sub-section">
