...
const Modal = ( {
	...
	return (
		<Transition.Root show={ open || false } as={ Fragment }>
			<Dialog as="div" className="spectra-ai relative z-[99999999]" onClose={ setOpen }>
				<Transition.Child
					as={ Fragment }
					...
					leaveTo="opacity-0"
				>
					<div className={ classNames( 'fixed inset-10 bg-background-tertiary/80 transition-opacity backdrop-blur-[20px] rounded-lg', overlayClassName ) } />
				</Transition.Child>
				...
				<div className="fixed inset-0 z-10 overflow-y-auto">
					<div className="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
						...
						>
							...
							>
								{ closeButton && ( <div className="absolute right-0 top-0 pr-3 pt-3 block">
									<button
										type="button"
