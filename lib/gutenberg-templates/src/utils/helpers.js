...
export const getSpectraProStatus = () => {
	const { spectra_pro_status } = ast_block_template_vars;
 ...
 * @return {{ active: boolean, inactive: boolean, notInstalled: boolean }} - An object with the status of the plugin.
 */
export const getSpectraStatus = () => {
	const { spectra_status } = ast_block_template_vars;
...
export const getAstraSitesProStatus = () => {
	const { astra_sites_pro_status } = ast_block_template_vars;
