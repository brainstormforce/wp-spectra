	...
	return (
		<div className={ `uagb-confirm-rollback-popup ${ show }` }>
            <div className="uagb-confirm-rollback-popup__content">
                <div className="uagb-confirm-rollback-popup__header">Rollback to Previous Version</div>
                <div className="uagb-confirm-rollback-popup__message">Are you sure you want to reinstall previous version?</div>
