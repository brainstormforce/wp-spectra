		...
		<div class="postbox-container uagb-sidebar" id="postbox-container-1">
			<div id="side-sortables">
				...
				<div class="postbox uagb-astra-sidebar">
					...
					<div class="inside">
						<p><?php esc_html_e( 'Join over 1,000,000+ active users empowering their websites with Astra! From beginners to industry leaders, everyone loves the Astra theme.', 'ultimate-addons-for-gutenberg' ); ?></p>
