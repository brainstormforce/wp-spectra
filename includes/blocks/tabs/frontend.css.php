...
$t_selectors = array(
	...
	'.uagb-tabs__wrap.uagb-tabs__hstyle2-tablet ul.uagb-tabs__panel li' => array_merge(
		array(
			'border-top-width'   => '0px',
			'border-right-width' => '0px',
			'border-left-width'  => '0px',
	...
	'.uagb-tabs__wrap.uagb-tabs__hstyle4-tablet ul.uagb-tabs__panel li.uagb-tab' => array(
		'border-radius' => '100%',
	),
	'.uagb-tabs__wrap.uagb-tabs__hstyle5-tablet'           => $overall_border_tablet,
	'.uagb-tabs__wrap.uagb-tabs__hstyle5-tablet ul.uagb-tabs__panel .uagb-tab' => array(
		'border-top-width'    => '0px',
		'border-right-width'  => '0px',
		'border-left-width'   => '0px',
		'border-bottom-width' => '0px',
	...
	'.uagb-tabs__wrap.uagb-tabs__vstyle7-tablet ul.uagb-tabs__panel .uagb-tab' => array_merge(
		array(
			'border-top-width'   => '0px',
			'border-right-width' => '0px',
			'border-left-width'  => '0px',
