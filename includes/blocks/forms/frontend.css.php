...
$toggle_border_bottom_fallback        = UAGB_Block_Helper::get_attribute_fallback( $toggle_border['border-bottom-width'], 'checkBoxcheckBoxToggleBorderBottomWidth', $block_name );
$toggle_border_top_tablet_fallback    = ( ! empty( $toggle_border_tablet['border-top-width'] ) && isset( $toggle_border_tablet['border-top-width'] ) ) ? $toggle_border_tablet['border-top-width'] : $toggle_border_top_fallback;
$toggle_border_left_tablet_fallback   = ( ! empty( $toggle_border_tablet['border-left-width'] ) && isset( $toggle_border_tablet['border-left-width'] ) ) ? $toggle_border_tablet['border-left-width'] : $toggle_border_left_fallback;
$toggle_border_right_tablet_fallback  = ( ! empty( $toggle_border_tablet['border-right-width'] ) && isset( $toggle_border_tablet['border-right-width'] ) ) ? $toggle_border_tablet['border-right-width'] : $toggle_border_right_fallback;
$toggle_border_bottom_tablet_fallback = ( ! empty( $toggle_border_tablet['border-bottom-width'] ) && isset( $toggle_border_tablet['border-bottom-width'] ) ) ? $toggle_border_tablet['border-bottom-width'] : $toggle_border_bottom_fallback;
$toggle_border_top_mobile_fallback    = ( ! empty( $toggle_border_mobile['border-top-width'] ) && isset( $toggle_border_mobile['border-top-width'] ) ) ? $toggle_border_mobile['border-top-width'] : $toggle_border_top_tablet_fallback;
$toggle_border_left_mobile_fallback   = ( ! empty( $toggle_border_mobile['border-left-width'] ) && isset( $toggle_border_mobile['border-left-width'] ) ) ? $toggle_border_mobile['border-left-width'] : $toggle_border_left_tablet_fallback;
$toggle_border_right_mobile_fallback  = ( ! empty( $toggle_border_mobile['border-right-width'] ) && isset( $toggle_border_mobile['border-right-width'] ) ) ? $toggle_border_mobile['border-right-width'] : $toggle_border_right_tablet_fallback;
$toggle_border_bottom_mobile_fallback = ( ! empty( $toggle_border_mobile['border-bottom-width'] ) && isset( $toggle_border_mobile['border-bottom-width'] ) ) ? $toggle_border_mobile['border-bottom-width'] : $toggle_border_bottom_tablet_fallback;
...
$toggle_border_radius_tl_tablet_fallback = ( ! empty( $toggle_border_tablet['border-top-left-radius'] ) && isset( $toggle_border_tablet['border-top-left-radius'] ) ) ? $toggle_border_tablet['border-top-left-radius'] : $toggle_border_radius_tl_fallback;
$toggle_border_radius_tr_tablet_fallback = ( ! empty( $toggle_border_tablet['border-top-right-radius'] ) && isset( $toggle_border_tablet['border-top-right-radius'] ) ) ? $toggle_border_tablet['border-top-right-radius'] : $toggle_border_radius_tr_fallback;
$toggle_border_radius_bl_tablet_fallback = ( ! empty( $toggle_border_tablet['border-bottom-left-radius'] ) && isset( $toggle_border_tablet['border-bottom-left-radius'] ) ) ? $toggle_border_tablet['border-bottom-left-radius'] : $toggle_border_radius_bl_fallback;
$toggle_border_radius_br_tablet_fallback = ( ! empty( $toggle_border_tablet['border-bottom-right-radius'] ) && isset( $toggle_border_tablet['border-bottom-right-radius'] ) ) ? $toggle_border_tablet['border-bottom-right-radius'] : $toggle_border_radius_br_fallback;
$toggle_border_radius_tl_mobile_fallback = ( ! empty( $toggle_border_mobile['border-top-left-radius'] ) && isset( $toggle_border_mobile['border-top-left-radius'] ) ) ? $toggle_border_mobile['border-top-left-radius'] : $toggle_border_radius_tl_tablet_fallback;
$toggle_border_radius_tr_mobile_fallback = ( ! empty( $toggle_border_mobile['border-top-right-radius'] ) && isset( $toggle_border_mobile['border-top-right-radius'] ) ) ? $toggle_border_mobile['border-top-right-radius'] : $toggle_border_radius_tr_tablet_fallback;
$toggle_border_radius_bl_mobile_fallback = ( ! empty( $toggle_border_mobile['border-bottom-left-radius'] ) && isset( $toggle_border_mobile['border-bottom-left-radius'] ) ) ? $toggle_border_mobile['border-bottom-left-radius'] : $toggle_border_radius_bl_tablet_fallback;
$toggle_border_radius_br_mobile_fallback = ( ! empty( $toggle_border_mobile['border-bottom-right-radius'] ) && isset( $toggle_border_mobile['border-bottom-right-radius'] ) ) ? $toggle_border_mobile['border-bottom-right-radius'] : $toggle_border_radius_br_tablet_fallback;
