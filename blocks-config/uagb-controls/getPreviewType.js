...
export const setDeviceType = ( device, updateInCustomizer = true ) => {
    const setPreviewDeviceType = dispatch( 'core/editor' )?.getDeviceType || dispatch( 'core/edit-post' )?.__experimentalSetPreviewDeviceType || dispatch( spectraStore )?.setDeviceType;
