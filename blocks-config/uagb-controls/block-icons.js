...
const UAGB_Block_Icons = {
	...
	section: el(
		'svg',
		{ width: 24, height: 24, viewBox: '2 2 20 20', fill: 'none', className: 'uagb-editor-icons' },
		el( 'path', {
			'fill': iconColor,
			'fill-rule': 'evenodd',
			'clip-rule': 'evenodd',
	...
	cf7_styler: el(
		'svg',
		{ width: 24, height: 24, className: 'uagb-editor-icons'  },
		el( 'path', {
			'fill': iconColor,
			'fill-rule': 'evenodd',
			'clip-rule': 'evenodd',
	...
	gf_styler: el(
		'svg',
		{ width: 24, height: 24, viewBox: '2 2 20 20', className: 'uagb-editor-icons'  },
		el( 'path', {
			fill: iconColor,
			d:
	...
	column: el(
		...
		el( 'path', {
			fill: iconColor,
			d:
				'M17.355 0.347h-14.71c-1.143 0-2.069 0.926-2.069 2.069v15.169c0 1.143 0.926 2.069 2.069 2.069h14.709c1.143 0 2.069-0.926 2.069-2.069v-15.169c0-1.142-0.926-2.069-2.068-2.069zM18.504 17.585c0 0.635-0.515 1.149-1.149 1.149h-14.71c-0.635 0-1.149-0.515-1.149-1.149v-15.169c0-0.635 0.514-1.149 1.149-1.149h14.71c0.635 0 1.149 0.515 1.149 1.149v15.169z',
		} ),
		el( 'path', {
			fill: iconColor,
			d:
				'M16.665 2.767h-5.516c-0.254 0-0.46 0.206-0.46 0.459v13.546c0 0.254 0.206 0.46 0.46 0.46h5.516c0.254 0 0.46-0.206 0.46-0.46v-13.546c0-0.253-0.206-0.459-0.46-0.459zM16.206 16.313h-4.597v-12.626h4.597v12.626z',
		} ),
		el( 'path', {
			fill: iconColor,
			d:
				'M8.851 2.767h-5.516c-0.254 0-0.46 0.206-0.46 0.459v13.546c0 0.254 0.206 0.46 0.46 0.46h5.516c0.254 0 0.46-0.206 0.46-0.46v-13.546c0-0.253-0.206-0.459-0.46-0.459zM8.391 16.313h-4.597v-12.626h4.597v12.626z',
		} )
	),
	marketing_button: el(
		'svg',
