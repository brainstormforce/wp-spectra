...
if ( ! class_exists( 'UAGB_Block_Helper' ) ) {
	...
	class UAGB_Block_Helper {
		...
		public static function uag_generate_deprecated_border_css( $current_css, $border_width, $border_radius, $border_color = '', $border_style = '' ) {
			...
			$gen_border_css['border-top-width']    = isseet( $current_css['border-top-width'] ) ? ( ! empty( $current_css['border-top-width'] ) ? $current_css['border-top-width'] : UAGB_Helper::get_css_value( $border_width, 'px' )) : UAGB_Helper::get_css_value( $border_width, 'px' );
			$gen_border_css['border-left-width']   = isseet( $current_css['border-left-width'] ) ? ( ! empty( $current_css['border-left-width'] ) ? $current_css['border-left-width'] : UAGB_Helper::get_css_value( $border_width, 'px' )) : UAGB_Helper::get_css_value( $border_width, 'px' );
			$gen_border_css['border-right-width']  = isseet( $current_css['border-right-width'] ) ? ( ! empty( $current_css['border-right-width'] ) ? $current_css['border-right-width'] : UAGB_Helper::get_css_value( $border_width, 'px' )) : UAGB_Helper::get_css_value( $border_width, 'px' );
			$gen_border_css['border-bottom-width'] = isseet( $current_css['border-bottom-width'] ) ? ( ! empty( $current_css['border-bottom-width'] ) ? $current_css['border-bottom-width'] : UAGB_Helper::get_css_value( $border_width, 'px' )) : UAGB_Helper::get_css_value( $border_width, 'px' );

			$gen_border_css['border-top-left-radius']     = ! empty( $current_css['border-top-left-radius'] ) ? ( isset( $current_css['border-top-left-radius'] ) ? $current_css['border-top-left-radius'] : UAGB_Helper::get_css_value( $border_radius, 'px' ) ) : UAGB_Helper::get_css_value( $border_radius, 'px' );
			$gen_border_css['border-top-right-radius']    = ! empty( $current_css['border-top-right-radius'] ) ? ( isset( $current_css['border-top-right-radius'] ) ? $current_css['border-top-right-radius'] : UAGB_Helper::get_css_value( $border_radius, 'px' ) ) : UAGB_Helper::get_css_value( $border_radius, 'px' );
			$gen_border_css['border-bottom-left-radius']  = ! empty( $current_css['border-bottom-left-radius'] ) ? ( isset( $current_css['border-bottom-left-radius'] ) ? $current_css['border-bottom-left-radius'] : UAGB_Helper::get_css_value( $border_radius, 'px' ) ) : UAGB_Helper::get_css_value( $border_radius, 'px' );
			$gen_border_css['border-bottom-right-radius'] = ! empty( $current_css['border-bottom-right-radius'] ) ? ( isset( $current_css['border-bottom-right-radius'] ) ? $current_css['border-bottom-right-radius'] : UAGB_Helper::get_css_value( $border_radius, 'px' ) ) : UAGB_Helper::get_css_value( $border_radius, 'px' );
