		...
		public static function get_marketing_btn_css( $attr, $id ) {
			...
			$selectors = array(
				...
				' .uagb-marketing-btn__link'          => array(
					'padding-left'   => UAGB_Helper::get_css_value( $btn_padding_left, $attr['paddingType'] ),
					'padding-right'  => UAGB_Helper::get_css_value( $btn_padding_right, $attr['paddingType'] ),
					'padding-top'    => UAGB_Helper::get_css_value( $btn_padding_top, $attr['paddingType'] ),
					'padding-bottom' => UAGB_Helper::get_css_value( $btn_padding_bottom, $attr['paddingType'] ),
					'border-style'   => $attr['borderStyle'],
					'border-width'   => UAGB_Helper::get_css_value( $attr['borderWidth'], 'px' ),
					'border-color'   => $attr['borderColor'],
					'border-radius'  => UAGB_Helper::get_css_value( $attr['borderRadius'], 'px' ),
