...
if ( ! class_exists( 'UAGB_Block_Helper' ) ) {
	...
	class UAGB_Block_Helper {
		...
		public static function get_how_to_css( $attr, $id ) {
			...
			$combined_selectors = UAGB_Helper::get_typography_css( $attr, 'materials', ' .uagb-how-to-materials__wrap .uagb-howto-req-materials-text', $combined_selectors );
			$combined_selectors = UAGB_Helper::get_typography_css( $attr, 'tools', ' .uagb-how-to-tools__wrap .uagb-howto-req-tools-text', $combined_selectors );
