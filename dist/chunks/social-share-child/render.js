...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".uagb-social-share__layout-vertical .block-list-appender {\n  width: 60px;\n  margin-top: 28px; }\n\n.uagb-social-share__layout-horizontal .block-list-appender {\n  margin-top: 0;\n  margin-left: 20px; }\n", "",{"version":3,"sources":["webpack://./src/blocks/social-share-child/editor.lazy.scss"],"names":[],"mappings":"AAAA;EACE,WAAW;EACX,gBAAgB,EAAE;;AAEpB;EACE,aAAa;EACb,iBAAiB,EAAE","sourcesContent":[".uagb-social-share__layout-vertical .block-list-appender {\n  width: 60px;\n  margin-top: 28px; }\n\n.uagb-social-share__layout-horizontal .block-list-appender {\n  margin-top: 0;\n  margin-left: 20px; }\n"],"sourceRoot":""}]);
// Exports
