...
const Render = props => {
  ...
  const splitBlock = function (before, after) {
    ...
    if (after) {
      ...
      blocks.push(Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_7__["createBlock"])('core/paragraph', {
        content: after
      }));
    }
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("article", {
  ...
  }, 'custom' !== dateFormat && Object(_wordpress_date__WEBPACK_IMPORTED_MODULE_4__["format"])(dateFormat, postDate) || postDate), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8__["RichText"], {
    tagName: headingTag,
    value: time_heading,
    ...
    onSplit: insertBlocksAfter ? function (before, after) {
      ...
      insertBlocksAfter([...blocks, Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_7__["createBlock"])('core/paragraph', {
        content: after
      })]);
    } : undefined,
    onRemove: () => onReplace([])
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8__["RichText"], {
    tagName: "p",
    value: time_desc,
    onChange: value => setAttributes({
      time_desc: value
  ...
  }, displayPostDate !== true && t_date && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, 'custom' !== dateFormat && Object(_wordpress_date__WEBPACK_IMPORTED_MODULE_4__["format"])(dateFormat, postDate) || postDate)));
};
