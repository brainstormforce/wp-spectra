...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".uagb-forms-checkbox-wrap input[type=\"checkbox\"],\n.uagb-form-checkbox-option input[type=\"checkbox\"] {\n  vertical-align: middle;\n  margin-right: 15px; }\n\n.uagb-forms-checkbox-controls {\n  margin-top: 10px; }\n\n.uagb-form-checkbox-option-delete.has-icon {\n  vertical-align: middle;\n  padding: 10px;\n  margin: 0; }\n\n.uagb-form-checkbox-option .uagb-inner-input-view {\n  margin-right: 20px; }\n", "",{"version":3,"sources":["webpack://./src/blocks/forms/child-blocks/checkbox/editor.lazy.scss"],"names":[],"mappings":"AAAA;;EAEE,sBAAsB;EACtB,kBAAkB,EAAE;;AAEtB;EACE,gBAAgB,EAAE;;AAEpB;EACE,sBAAsB;EACtB,aAAa;EACb,SAAS,EAAE;;AAEb;EACE,kBAAkB,EAAE","sourcesContent":[".uagb-forms-checkbox-wrap input[type=\"checkbox\"],\n.uagb-form-checkbox-option input[type=\"checkbox\"] {\n  vertical-align: middle;\n  margin-right: 15px; }\n\n.uagb-forms-checkbox-controls {\n  margin-top: 10px; }\n\n.uagb-form-checkbox-option-delete.has-icon {\n  vertical-align: middle;\n  padding: 10px;\n  margin: 0; }\n\n.uagb-form-checkbox-option .uagb-inner-input-view {\n  margin-right: 20px; }\n"],"sourceRoot":""}]);
// Exports
