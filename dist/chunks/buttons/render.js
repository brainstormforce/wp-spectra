...
const Render = props => {
  ...
  return isPreview ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("img", {
    ...
    className: classnames__WEBPACK_IMPORTED_MODULE_0___default()(className, 'uagb-buttons__outer-wrap', `uagb-btn__${buttonSize}-btn`, `uagb-editor-preview-mode-${deviceType.toLowerCase()}`, `uagb-block-${props.clientId.substr(0, 8)}`)
