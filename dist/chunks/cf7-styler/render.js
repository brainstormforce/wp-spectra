...
const Render = props => {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    ...
    className: classnames__WEBPACK_IMPORTED_MODULE_0___default()(`uagb-cf7-styler__align-${align}`, `uagb-cf7-styler__field-style-${fieldStyle}`, `uagb-cf7-styler__btn-align-${buttonAlignment}`, `uagb-cf7-styler__highlight-style-${validationMsgPosition}`, enableOveride ? 'uagb-cf7-styler__check-style-enabled' : '', enableHighlightBorder ? 'uagb-cf7-styler__highlight-border' : '')
