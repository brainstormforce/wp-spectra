...
var InnerBlockLayoutContext = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createContext"])({
  parentName: '',
  parentClassName: '',
  isLoading: false
});
var useInnerBlockLayoutContext = function useInnerBlockLayoutContext() {
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["useContext"])(InnerBlockLayoutContext);
};
var InnerBlockLayoutContextProvider = function InnerBlockLayoutContextProvider(_ref) {
  var _ref$parentName = _ref.parentName,
      ...
      parentClassName = _ref$parentClassName === void 0 ? '' : _ref$parentClassName,
...
var renderPostLayout = function renderPostLayout(blockName, post, layoutConfig, attributes, categoriesList) {
  ...
  var children = [];
  return layoutConfig.map(function (_ref2) {
...
function getRegisteredBlockComponents(context) {
  ...
  return _objectSpread(_objectSpread({}, parentInnerBlocks), registeredBlockComponents.any);
}
/**
...
var getPostLayoutConfig = function getPostLayoutConfig(innerBlocks) {
  ...
  return innerBlocks.map(function (block) {
    return [block.name, _objectSpread(_objectSpread({}, block.attributes), {}, {
      post: undefined,
...
var Slider = /*#__PURE__*/Object(react__WEBPACK_IMPORTED_MODULE_3__["lazy"])(function () {
  return __webpack_require__.e(/*! import() | chunks/post-carousel/react-slick */ "vendors~chunks/testimonial/react-slick").then(__webpack_require__.t.bind(null, /*! react-slick */ "./node_modules/react-slick/lib/index.js", 7));
});
...
function Blog(props) {
  ...
  var equalHeightClass = equalHeight ? 'uagb-post__carousel_equal-height' : '';
  var settings = {
  ...
  if (columns >= displayPosts.length) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("div", {
      className: classnames__WEBPACK_IMPORTED_MODULE_0___default()(className, 'uagb-post-grid', 'uagb-post__arrow-outside', "uagb-post__image-position-".concat(imgPosition), "".concat(equalHeightClass), "uagb-editor-preview-mode-".concat(deviceType.toLowerCase()), "uagb-block-".concat(block_id)),
      "data-blog-id": block_id
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("div", {
      className: classnames__WEBPACK_IMPORTED_MODULE_0___default()('is-carousel', "uagb-post__columns-".concat(columns), "uagb-post__columns-tablet-".concat(tcolumns), "uagb-post__columns-mobile-".concat(mcolumns), 'uagb-post__items')
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_function__WEBPACK_IMPORTED_MODULE_2__["InnerBlockLayoutContextProvider"], {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("div", {
    className: classnames__WEBPACK_IMPORTED_MODULE_0___default()(className, 'uagb-post-grid', 'uagb-post__arrow-outside', 'uagb-slick-carousel', "uagb-post__image-position-".concat(imgPosition), "".concat(equalHeightClass), "uagb-block-".concat(block_id)),
    "data-blog-id": block_id,
    ...
    className: classnames__WEBPACK_IMPORTED_MODULE_0___default()('is-carousel', "uagb-post__columns-".concat(columns), 'uagb-post__items')
  }, settings), all_posts)));
}
...
var Render = function Render(props) {
  ...
  var renderEditMode = function renderEditMode() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__["Placeholder"], {
      ...
      parentClassName: "uagb-block-grid"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("article", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
  ...
  var renderViewMode = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__["Disabled"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_blog__WEBPACK_IMPORTED_MODULE_2__["default"], {
    attributes: attributes,
    className: props.className,
